import{C as c}from"./web-ifc-api-BAs6yRon.js";import{S as b}from"./stats.min-GTpOrGrX.js";import{d as p,R as m,m as u}from"./index-CqPyogbW.js";import{d,l as f,x as h,b as g,h as v,C as x}from"./index-crgZK0po.js";import{e as $}from"./index-BelrnDHb.js";import"./_commonjsHelpers-Cpj98o6Y.js";const k=document.getElementById("container"),t=new d,E=t.get(f),a=E.create();a.scene=new h(t);a.renderer=new $(t,k);a.camera=new g(t);a.scene.three.background=null;t.init();a.camera.controls.setLookAt(12,6,8,0,0,-10);a.scene.setup();const r=t.get(v);r.config.color.set(6710886);const w=r.create(a);a.scene.three.background=null;const y=new x(t),R=await fetch("https://thatopen.github.io/engine_components/resources/small.frag"),S=await R.arrayBuffer(),C=new Uint8Array(S),A=y.load(C);a.scene.three.add(A);const{postproduction:n}=a.renderer;n.enabled=!0;n.customEffects.excludedMeshes.push(w.three);const s=n.n8ao.configuration,o=new b;o.showPanel(2);document.body.append(o.dom);o.dom.style.left="0px";o.dom.style.zIndex="unset";a.renderer.onBeforeUpdate.add(()=>o.begin());a.renderer.onAfterUpdate.add(()=>o.end());p.init();const l=m.create(()=>u`
