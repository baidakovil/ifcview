import{B as u,M as h,a as w}from"./web-ifc-api-BAs6yRon.js";import{S as x}from"./stats.min-GTpOrGrX.js";import{d as $,R as g,m as v}from"./index-CqPyogbW.js";import{d as f,l as k,x as P,Y as j,r as y,h as F}from"./index-crgZK0po.js";import"./_commonjsHelpers-Cpj98o6Y.js";const O=document.getElementById("container");let t=new f,c=t.get(k),e=c.create();e.scene=new P(t);e.renderer=new j(t,O);e.camera=new y(t);e.scene.setup();await e.camera.controls.setLookAt(3,3,3,0,0,0);t.init();e.scene.three.background=null;let l=new u,d=new h({color:"#6528D7"}),n=new w(l,d);n.position.set(0,.5,0);e.scene.three.add(n);e.meshes.add(n);let m=t.get(F),p=m.create(e);e.camera.projection.onChanged.add(()=>{const o=e.camera.projection.current;p.fade=o==="Perspective"});const r=new x;r.showPanel(2);document.body.append(r.dom);r.dom.style.left="0px";r.dom.style.zIndex="unset";e.renderer.onBeforeUpdate.add(()=>r.begin());e.renderer.onAfterUpdate.add(()=>r.end());$.init();const a=g.create(()=>v`
    ...
    `);document.body.append(a);const C=g.create(()=>v`
